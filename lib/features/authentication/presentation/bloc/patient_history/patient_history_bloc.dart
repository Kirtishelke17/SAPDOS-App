...
class PatientHistoryBloc
  ...
  void _onFetchPatientHistory(
    ...
    try {
      ...
      final history = ['Blood report', 'CT Scan Report', 'Follow up'];
      final prescriptions = ['26 March 2022', '13 April 2022'];
      emit(
          PatientHistoryLoaded(history: history, prescriptions: prescriptions));
    } catch (e) {
